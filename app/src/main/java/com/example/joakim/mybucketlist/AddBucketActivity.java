...
public class AddBucketActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createBucketButton = (Button) findViewById(R.id.createBucketButton);
        createBucketButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                txtInputNameOnBucket = (EditText) findViewById(R.id.txtInputNameOnBucket);
                nameOnBucket = txtInputNameOnBucket.getText().toString();
